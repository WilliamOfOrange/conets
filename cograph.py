...
class ComponentNode(ABC):
    ...
    @abstractmethod
    def on_t_delta(self, tick: int, edge_deltas: Dict[str, Tuple[ApparentEMFState, PhysicalProperties]]) -> Dict[
        str, Tuple[ApparentEMFState, PhysicalProperties]]:
        raise NotImplementedError()
...
class Resistor(ComponentNode):
    ...
    def on_t_delta(self, tick: int,
                   edge_deltas: Dict[UUID, Tuple[ApparentEMFState, PhysicalProperties]]) -> PhysicalProperties:
        raise NotImplementedError()
...
class VoltageDC(ComponentNode):
    ...
    def on_t_delta(self, tick: int, edge_deltas: Dict[str, Tuple[ApparentEMFState, PhysicalProperties]]) \
            -> Dict[str, Tuple[ApparentEMFState, PhysicalProperties]]:
        raise NotImplementedError()
